...
function ValidateLengthConverterForm()
{
    ...
    {
        _showerror("fromLength", "Enter valid Length.");
        return false;
    }
...
;
        ...
        _hideelement("OutputResult");
        _ShowElement("OutputInfo", "flex");
    }
}
...
function CalculateLength()
{
    if(ValidateLengthConverterForm())
    {
        ...
        //result div show
        _hideelement("OutputInfo");
        _hideelement("OutputResult", "flex");
    }
}
